...
// ** Actions Imports
import { fetchDataAdmin } from 'src/store/apps/logistique'
  ...
  const columns: GridColDef[] = [
    {
      ...
      renderCell: ({ row }: CellType) => {
        const phone = row?.instalateurId?.phone
        const fullName = row?.instalateurId?.fullName
